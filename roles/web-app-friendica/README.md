...
flowchart LR
    ...
    svc_friendica -.-> dpt_web_app_fediwall
```
...
Run the published image to provision the inventory and deploy Friendica to a managed server (the mounted volume persists the inventory between the two runs):
