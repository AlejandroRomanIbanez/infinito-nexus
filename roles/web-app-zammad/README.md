...
flowchart LR
    ...
    dep_svc_db_memcached -.-> svc_memcached
...
Run the published image to provision the inventory and deploy Zammad to a managed server (the mounted volume persists the inventory between the two runs):
