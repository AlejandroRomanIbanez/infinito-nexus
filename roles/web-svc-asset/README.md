...
Run the published image to provision the inventory and deploy Assets Server to a managed server (the mounted volume persists the inventory between the two runs):
