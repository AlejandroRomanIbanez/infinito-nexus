...
Run the published image to provision the inventory and deploy Mobilizon to a managed server (the mounted volume persists the inventory):

```bash
APP=web-app-mobilizon
HOST=<your-server>
