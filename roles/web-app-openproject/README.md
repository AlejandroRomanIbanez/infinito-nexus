...
Run the published image to provision the inventory and deploy OpenProject to a managed server (the mounted volume persists the inventory):

```bash
APP=web-app-openproject
HOST=<your-server>
