...
flowchart LR
    ...
    svc_qdrant -.-> dpt_web_app_flowise
```
...
Run the published image to provision the inventory and deploy Qdrant to a managed server (the mounted volume persists the inventory between the two runs):
