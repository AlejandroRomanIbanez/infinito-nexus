...
flowchart LR
    ...
    dep_svc_db_typesense -.-> svc_typesense
...
Run the published image to provision the inventory and deploy Funkwhale to a managed server (the mounted volume persists the inventory between the two runs):
