...
Run the published image to provision the inventory and deploy Prometheus to a managed server (the mounted volume persists the inventory):

```bash
APP=web-app-prometheus
HOST=<your-server>
