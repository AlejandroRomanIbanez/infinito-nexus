# nocheck: mirrored-unit-test - rewrites files inside the installed decidim-core gem,
# located by globbing /usr/local/bundle; the patch targets only exist in the running
# container
